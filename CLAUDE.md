...
This file mirrors `AGENTS.md` for Claude-based coding agents. Keep project rules, commands, architecture notes, and image workflow synchronized with `AGENTS.md`.
